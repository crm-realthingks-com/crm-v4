...
export const ConvertToDealModal = ({ open, onOpenChange, lead, onSuccess }: ConvertToDealModalProps) => {
  ...
  // Create initial deal data based on lead with proper Lead Owner display name
  const initialDeal: Deal = {
    ...
    modified_by: null,
    deal_name: `Deal for ${lead.lead_name}`,
    stage: 'Lead',
    project_name: '', // Keep blank as requested
    customer_name: lead.company_name || '',
    lead_name: lead.lead_name,
    lead_owner: lead.created_by ? (displayNames[lead.created_by] || 'Unknown User') : '', // Auto-populate with display name
    region: lead.country || '',
